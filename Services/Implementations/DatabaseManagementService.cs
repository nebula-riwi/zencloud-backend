...
namespace ZenCloud.Services.Implementations
{
    public class DatabaseManagementService : IDatabaseManagementService
    {
        ...
        // Expresiones regulares para validación segura
        private readonly Regex _validIdentifierRegex = new Regex("^[a-zA-Z_][a-zA-Z0-9_]{0,63}$", RegexOptions.Compiled);
        private readonly Regex _sqlInjectionPattern = new Regex(@"(;|\-\-|#|/*|*/|union.*select|insert.*into|drop|delete.*from|update.*set|create|alter|grant|revoke|exec|execute|xp_|sp_|load_file|outfile|dumpfile)", 
